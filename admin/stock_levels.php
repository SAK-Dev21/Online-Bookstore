        ...
        <section class="stock-levels">
            ...
            <div class="stock-table">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><img src="path/to/thumbnail1.jpg" alt="Book Thumbnail"></td>
                            <td>Book Title 1</td>
                            <td>978-3-16-148410-0</td>
                            <td>10</td>
                        </tr>
                        <!-- Repeat similar rows for other books -->
                    </tbody>
                </table>
            </div>
            <div class="redirect-buttons" style="justify-content: flex-end">
                <a href="add_stock.html" class="green-btn">Add Stock</a>
            </div>
        </section>
    </main>
